...
script plugin for [Lider Ahenk project](http://www.liderahenk.org.tr).
...
3. Navigate to _lider-ahenk-script-plugin/scripts_ directory and run `build-plugin.sh`.
...
1. Open Eclipse, go to 'Run --> Debug Configurations' menu and on 'Plugins' tab, select _lider-console-script_
...
1. Create a soft link for _ahenk-script/script_ directory via `sudo ln -s lider-ahenk-script-plugin/ahenk-script/script/ /opt/ahenk/plugins`
